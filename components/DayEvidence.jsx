      ...
      <div className="bg-white rounded-[10px] mb-8 shadow-lg">
        ...
        >
          <div className="w-[150px] sm:w-[220px] md:w-[200px] lg:w-[220px] m-auto">
            ...
            <div 
              className={`
                ${props.evidencePerDay.first.status === 'pending' && "flex flex-col p-[16px] md:p-[20px] bg-[#F2F2F2] border border-[#757575] items-center gap-3 rounded-[10px]"}
                ${props.evidencePerDay.first.status === 'available' && "flex flex-col p-[16px] md:p-[20px] bg-[#F2F2F2] border border-[#f2a94a] items-center gap-3 rounded-[10px]"}
                ${props.evidencePerDay.first.status === 'success' && "flex flex-col p-[16px] md:p-[20px] bg-[#F2F2F2] border border-[#5a9545] items-center gap-3 rounded-[10px]"}
                ${props.evidencePerDay.first.status === 'defaulted' && "flex flex-col p-[16px] md:py-[20px] md:px-[14px] bg-[#F2F2F2] border border-[#ab3131] items-center gap-3 rounded-[10px]"}
              `}
            >
              <button className="w-[125px] h-[125px] sm:w-[160px] sm:h-[160px] flex justify-center items-center bg-white rounded-[10px] shadow-lg" onClick={() => setShowModal1(true)}>
                ...
                : 
                  <img src={props.evidencePerDay.first.url} alt="New Pet Image" className="w-full h-full object-scale-down rounded-lg"/>
                }
              </button>
              { props.evidencePerDay.first.status === 'pending' &&
                <p className="font-medium text-[14px] lg:text-[16px] text-center text-[#757575] py-[4px] px-[10px] bg-white rounded-full">Periodo no abierto</p>
              }
              { props.evidencePerDay.first.status === 'available' &&
                <p className="font-medium text-[14px] lg:text-[16px] text-center text-white py-[4px] px-[10px] bg-[#f2a94a] rounded-full">Periodo abierto</p>
              }
              { props.evidencePerDay.first.status === 'success' &&
                <p className="font-medium text-[14px] lg:text-[16px] text-center text-white py-[4px] px-[10px] bg-[#5a9545] rounded-full">Requisito cumplido</p>
              }
              { props.evidencePerDay.first.status === 'defaulted' &&
                <p className="font-medium text-[14px] lg:text-[16px] text-center text-white py-[4px] px-[10px] bg-[#ab3131] rounded-full">Requisito inclumplido</p>
              }
            </div>
          ...
          <div className="w-[150px] sm:w-[220px] md:w-[200px] lg:w-[220px] m-auto">
            ...
            <div 
              className={`
                ${props.evidencePerDay.second.status === 'pending' && "flex flex-col p-[16px] md:p-[20px] bg-[#F2F2F2] border border-[#757575] items-center gap-3 rounded-[10px]"}
                ${props.evidencePerDay.second.status === 'available' && "flex flex-col p-[16px] md:p-[20px] bg-[#F2F2F2] border border-[#f2a94a] items-center gap-3 rounded-[10px]"}
                ${props.evidencePerDay.second.status === 'success' && "flex flex-col p-[16px] md:p-[20px] bg-[#F2F2F2] border border-[#5a9545] items-center gap-3 rounded-[10px]"}
                ${props.evidencePerDay.second.status === 'defaulted' && "flex flex-col p-[16px] md:py-[20px] md:px-[14px] bg-[#F2F2F2] border border-[#ab3131] items-center gap-3 rounded-[10px]"}
              `}
            >
              <button className="w-[125px] h-[125px] sm:w-[160px] sm:h-[160px] flex justify-center items-center bg-white rounded-[10px] shadow-lg" onClick={() => setShowModal2(true)}>
                ...
                ?
                  <p className='text-[16px]'>N / A</p>
                : 
                  <img src={props.evidencePerDay.second.url} alt="New Pet Image" className="w-full h-full object-scale-down rounded-lg"/>
                }
              </button>
          ...
          <div className="col-span-2 md:col-span-1 w-[150px] sm:w-[220px] md:w-[200px] lg:w-[220px] m-auto">
            ...
            <div 
              className={`
                ${props.evidencePerDay.third.status === 'pending' && "flex flex-col p-[16px] md:p-[20px] bg-[#F2F2F2] border border-[#757575] items-center gap-3 rounded-[10px]"}
                ${props.evidencePerDay.third.status === 'available' && "flex flex-col p-[16px] md:p-[20px] bg-[#F2F2F2] border border-[#f2a94a] items-center gap-3 rounded-[10px]"}
                ${props.evidencePerDay.third.status === 'success' && "flex flex-col p-[16px] md:p-[20px] border bg-[#F2F2F2] border-[#5a9545] items-center gap-3 rounded-[10px]"}
                ${props.evidencePerDay.third.status === 'defaulted' && "flex flex-col p-[16px] md:py-[20px] md:px-[14px] bg-[#F2F2F2] border border-[#ab3131] items-center gap-3 rounded-[10px]"}
              `}
            >
              <button className="w-[125px] h-[125px] sm:w-[160px] sm:h-[160px] flex justify-center items-center bg-white rounded-[10px] shadow-lg" onClick={() => setShowModal3(true)}>
                ...
                ?
                  <p className='text-[16px]'>N / A</p>
                : 
                  <img src={props.evidencePerDay.third.url} alt="New Pet Image" className="w-full h-full object-scale-down rounded-lg"/>
                }
              </button>
