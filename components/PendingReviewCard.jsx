export default function PendingReviewCard({ name }) {
  return (
    <main className="rounded-[20px] bg-white p-[20px] flex flex-col w-full sm:w-[460px] gap-5 justify-center items-center md:min-h-[300px] md:max-h-[300px] min-h-[375px]">
