                ...
                <>
                    ...
                    <section className='max-w-[1024px] mx-auto lg:py-[12px] h-[calc(100%-224px)] md:h-[calc(100%-248px)] lg:h-[calc(100%-256px)]'>
                        <div className='bg-white h-full lg:rounded-xl p-[12px] md:p-[16px] flex flex-col gap-[16px]'>
                                            ...
                                            <div key='index' className='flex gap-[12px]'>
                                                {
                                                    ...
                                                    ? 
                                                    <>
                                                        <img src={reservation.client.picture} className='rounded-full object-cover h-[52px] w-[52px]'/>
                                                        <div className='p-[12px] bg-[#2B2E4A] flex flex-col gap-[10px] rounded-lg'>
                                                            <div className='flex flex-col gap-[2px]'>
                                                                <p className='font-bold font-[nunito] text-[#F2F2F2]'>{reservation.client.name} {reservation.client.lastname}</p>
                                                    ...
                                                    :
                                                    <>
                                                        <img src={reservation.host.picture} className='rounded-full object-cover h-[52px] w-[52px]'/>
                                                        <div className='p-[12px] bg-[#FF7068] flex flex-col gap-[10px] rounded-lg'>
                                                            <div className='flex flex-col gap-[2px]'>
                                                                <p className='font-bold font-[nunito] text-[#F2F2F2]'>{reservation.host.name} {reservation.host.lastname}</p>
                                                                <p className='font-[nunito] text-[#F2F2F2] text-[12px]'>{new Date(item.date).toLocaleString()}</p>
                                                            </div>
                                                            <p className='text-[#F2F2F2] font-[nunito]'>{item.message}</p>
                                                        </div>
                            ...
                            <form className='h-1/5 flex gap-[16px] items-center' 
                            onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <button type='submit' className='w-1/5 rounded-xl bg-[#E91E63] font-[nunito] text-[20px] h-fit py-[12px] text-white hover:scale-[102%] hover:shadow-lg transition'>
                                    Enviar
                                </button>
                            </form>
                        </div>
