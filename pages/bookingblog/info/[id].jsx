...
export default function Info({ reservation }) {
  ...
  useEffect(() => {
    ...
    reservation.data.client,
    reservation.data.host,
    reservation.host,
    router,
  ]);
              ...
              <div className="rounded-xl bg-white w-full lg:w-1/2 hover:scale-[102%] hover:shadow-xl transition group">
                ...
                <div className="flex flex-col gap-[16px] p-[16px] rounded-b-xl text-[16px]">
                  ...
                  <div className="flex justify-between">
                    ...
                    <p>
                      {new Date(reservation.data.finishDate).toDateString()}
                    </p>
                  </div>
                </div>
              </div>
              <div className="rounded-xl bg-white w-full lg:w-1/2 hover:scale-[102%] hover:shadow-xl transition group">
                ...
                <div className="flex flex-col gap-[16px] p-[16px] text-[16px]">
                  <div className="flex justify-between">
                    <p>Nombre</p>
                    <p>
                      {reservation.data.host.name}{" "}
                      {reservation.data.host.lastname}
                    </p>
                  </div>
                  <div className="flex justify-between">
                    <p>Celular</p>
                  ...
                  <div className="flex justify-between">
                    <p>Domicilio</p>
                    <p>
                      {reservation.data.host.accommodation.address.street} #
                      {
                        reservation.data.host.accommodation.address
                          .externalNumber
                      }
                    </p>
                  </div>
                  ...
                  <div className="flex justify-between">
                    <p>Ciudad</p>
                    <p>
                      {reservation.data.host.accommodation.address.city},{" "}
                      {reservation.data.host.accommodation.address.state}
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex flex-col gap-[16px] p-[16px] text-[16px]">
                  <div className="flex justify-between">
                    ...
                    <div className="flex w-1/2 justify-between">
                      <p>
                        {reservation.data.pet[0].type} |{" "}
                        {reservation.data.pet[0].size}
                      </p>
                  ...
                  <div className="flex justify-between">
                    ...
                    <div className="flex w-1/2 justify-between">
                      <p>
                        {reservation.data.cost.nights} x ${" "}
                        {reservation.data.cost.costPerNight}
                      </p>
                      <p>
                        ${" "}
                        {reservation.data.cost.nights *
                          reservation.data.cost.costPerNight}
                      </p>
                    </div>
                  </div>
